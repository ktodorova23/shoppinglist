...
import com.shoppinglist.shoppinglist.model.binding.UserLoginBindingModel;
import com.shoppinglist.shoppinglist.model.binding.UserRegisterBindingModel;
...
public class UserController {
    ...
    public String registerConfirm(@Valid UserRegisterBindingModel userRegisterBindingModel,
        ...
        boolean passwordsAreEqual = userRegisterBindingModel.getPassword().equals(userRegisterBindingModel.getConfirmPassword());

        if (bindingResult.hasErrors() || !passwordsAreEqual) {
